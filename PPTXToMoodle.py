...
class fenetre(tk.Tk):
    ...
    def envoyer(self):
        parent = "id dossier drive, fin de l'url sur google drive dans un navigateur"
    ...
    def changement_apparence(self): #fin partie graphique placement et parametrage des objets
        ...
        self.frameWeb.parent.grid(row = 1, column = 0, padx = 5, pady = 5)
        self.frameWeb.buttonEnvoyer.grid(row = 1, column = 1, padx = 5, pady = 5) #grid pour les boutons solitaires
        
        self.frameWeb.label2.grid(row = 3, column = 0,columnspan=2, padx = 5, pady = 5)

        self.frameWeb.id.grid(row = 4, column = 0, padx = 5, pady = 5)
        self.frameWeb.buttonname.grid(row = 4, column = 1, padx = 5, pady = 5)
